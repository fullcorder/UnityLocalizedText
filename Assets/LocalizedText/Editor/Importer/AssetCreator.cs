...
#pragma warning restore 168
            {
                LocalTextLogger.Error("Parse Fail.The number of columns may be incorrect");
            }
        ...
        private static void CreteKeyDefinitionFile(Settings settings, string csv)
        {
            ...
            lines.AppendLine();
            lines.AppendFormat("public partial class {0}", settings.KeyDefinitionClassName);
            lines.AppendLine();
            lines.Append("{");
            lines.AppendLine();
